...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
/**
 * Internal data view storage for: AB03_OA
 **/
public class AB03_OA extends ViewBase implements IExportView, Serializable
{
  // Entity View: EXP
  //        Type: IEF_SUPPLIED
  /**
  ...
  public static AB03_OA getInstance()
  {
    return new AB03_OA();
  }
  /**
  ...
  {
    this.copyFrom((AB03_OA) orig);
  }
  
  /**
   * Sets the current instance based on the passed view.
   **/
  public void copyFrom(AB03_OA orig)
  {
